                    ...
                    <div class="modal-body input-group">
                        <slot name="body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="Date" name="Date" v-model="Issue.Date" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <tr v-for="descr in Issue.IssueDetails" v-bind:key="descr.Id">
                                  <td>
                                      <textarea cols="120" v-on:keyup="onChange" style="max-height: 80px; height: 80px; resize: none;" maxlength="255" v-model="descr.Description" class="form-control col-md-9" name="IssueDetails[]" placeholder="Enter task"></textarea>
                                  </td>
...
<script>
  ...
  export default{
    props: ['Issues', 'Issue', 'Persons', 'StartUrl'],
    data: function () {
      return {
    ...
    methods: {
      ...
      onSave () {
        ...
        xhr.open('POST', this.StartUrl + 'AddOrUpdateJson', true)
